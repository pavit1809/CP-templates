...
//main code........ 
// Driver Code
// will work for both connected and disconnected graph
...
void dfsutility(vi adj[],vector<bool> &visited,int startingvertex)
{
	visited[startingvertex]=true;
	cout<<startingvertex<<nl;
	for(int i=0;i<adj[startingvertex].size();i++)
	{
		if (visited[adj[startingvertex][i]]==false){
			dfsutility(adj,visited,adj[startingvertex][i]);
		}
	}
}
void DFS(vi adj[],int noofvertices)
{
